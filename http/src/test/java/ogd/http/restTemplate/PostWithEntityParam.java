...
public class PostWithEntityParam extends Base {
    ...
    @Test
    public void send() {
        ResponseEntity<Hello> responseEntity = restTemplate.postForEntity(PATH_POST_WITH_ENTITY_PARAM, h, Hello.class);
    ...
    @Test
    public void send2() {
        Hello hello = restTemplate.postForObject(PATH_POST_WITH_ENTITY_PARAM, h, Hello.class);
