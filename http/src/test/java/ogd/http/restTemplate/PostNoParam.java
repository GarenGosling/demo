...
public class PostNoParam extends Base {
    ...
    @Test
    public void send() {
        ResponseEntity<Hello> responseEntity = restTemplate.postForEntity(PATH_POST, null, Hello.class);
    ...
    @Test
    public void send2() {
        Hello hello = restTemplate.postForObject(PATH_POST, null, Hello.class);
